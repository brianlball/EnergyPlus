  ...
  #set( ENV{DDONLY} y)
  execute_process(COMMAND "${CMAKE_COMMAND}" -E remove_directory "${BINARY_DIR}/${TEST_DIR}/first")
  ...
  #TODO modify IDF to do that
	  ...
	  execute_process(COMMAND "${CMAKE_COMMAND}" -E copy "${BINARY_DIR}/${TEST_DIR}/first/eplusout.csv" "${BINARY_DIR}/${TEST_DIR}/first/eplusout_first.csv" )

  # Clean up remove idf
  execute_process(COMMAND "${CMAKE_COMMAND}" -E remove "${BINARY_DIR}/${TEST_DIR}/first/in.idf")
